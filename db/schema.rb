...
ActiveRecord::Schema.define(version: 2020_05_04_163301) do
  ...
  create_table "spotify_client_logins", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "ClientId"
